...
Consider enabling Astro’s experimental Content Security Policy feature to help protect against cross-site scripting (XSS) risks if using user input with the navigate() API.
Fallback control
